...
namespace Felli
{
    ...
    /// on the x axis and 0 through 4 inclusive on the y axis. This is so we 
    /// can pass them to the the Unravelled board.
    /// </details>
    class Board
    {
        ...
        /// </summary>
        /// <param name="piece">The piece to check, either Black or White
        /// </param>
        /// <returns>Returns false if there isn't any piece of that type.
        /// </returns>
        ...
        /// </summary>
        /// <param name="piece">The piece to get the name of. Must be 'White' 
        /// or 'Black'</param>
        ...
        /// </summary>
        /// <param name="piece">The piece to process, must be 'White' or 
        /// 'Black'</param>
